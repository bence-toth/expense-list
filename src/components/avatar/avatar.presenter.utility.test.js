...
describe('generateInitials', () => {
  ...
  it('Should work for Superman', () => {
    expect(generateInitials({name: 'Superman'})).toEqual('S')
  })
  it('Should work for Kennedy', () => {
    expect(generateInitials({name: 'John F. Kennedy'})).toEqual('JF')
  })
  it('Should work for JRR Tolkien', () => {
    expect(generateInitials({name: 'John Ronald Reuel Tolkien'})).toEqual('JR')
  })
})
...
describe('generateBackgroundColor', () => {
  ...
  it('Should generate different colors for people with different names but same initials', () => {
